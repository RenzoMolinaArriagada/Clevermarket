...
<h4>Editando el código {{$codigo->nombre}}</b></h4>
...
<div class="container-fluid mt-3">
	...
	<div class="row">
		<form action="{{route('fid.editCodigoDescuento',$codigo)}}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
			@csrf
			<x-admin.fidelizacion.codigos_descuento
				:codigo="$codigo"
			/>
			<x-admin.form-buttons
				:ruta="route('fid.editCodigoDescuento',$codigo)"
			/>	
		</form>
	</div>
</div>
